...
const inputWrapperClassName = cn(
  "relative w-full rounded-lg border border-gray-300 bg-white transition-all overflow-hidden",
  "focus-within:border-[#16a34a] focus-within:ring-2 focus-within:ring-[#16a34a]/20"
);

const inputClassName =
  "w-full bg-transparent outline-none placeholder:text-gray-400 py-3 pr-4";

export const Input = ({ className, wrapperClassName, ...props }) => {
  return (
...
export const SmoothInput = ({
  ...
  const displayPlaceholder = params.placeholder;
  ...
  return (
    <div className={cn(inputWrapperClassName, wrapperClassName)}>
      ...
      >
        ...
        />
        <motion.div
          className="pointer-events-none col-start-1 col-end-2 row-start-1 row-end-2 h-[1.2em] w-[2px] self-center"
          style={{ x: springCaretX, opacity: caretOpacity, backgroundColor: '#16a34a' }}
        />
      </div>
    </div>
  );
